...
class SerialWaitAndReadStrNode(BaseNode):
    ...
    def __init__(self, runtime_dict: dict):
        super(SerialWaitAndReadStrNode, self).__init__(runtime_dict)

    def run(self, _record):
        self.runtime["var"]["read to"].set_value(str(self.runtime["var"]["COM"].wait_and_read(), "utf8"))
